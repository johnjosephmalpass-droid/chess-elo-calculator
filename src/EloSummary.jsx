...
export default function EloSummary({ lastElo, avg5, history }) {
  if (!lastElo) return <div className="text-neutral-400 text-sm">Finish a game to get an estimate.</div>;
  return (
    <div className="space-y-2">
      <div className="text-4xl font-semibold tracking-tight">{lastElo.elo}</div>
      <div className="text-sm text-neutral-300">
        Confidence: <span className="font-medium text-neutral-100">{lastElo.conf}%</span>
      </div>
