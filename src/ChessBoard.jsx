        ...
        return (
          <button
            ...
            className={[
              ...
              "focus:outline-none",
              dark ? "bg-[#1f2937]" : "bg-[#111827]",
              "hover:brightness-110",
              isSel ? "ring-2 ring-sky-300 z-10" : "",
              isMove ? "outline outline-2 outline-emerald-400/70" : "",
            ].join(" ")}
            title={sq}
          >
            {isMove && !pc && (
              <span className="absolute w-3 h-3 rounded-full bg-emerald-300/70" />
            )}
            <span
              className={[
                "leading-none",
                ...
                isWhitePiece
                  ...
                  : "text-neutral-100 [text-shadow:0_2px_0_rgba(0,0,0,0.85),0_0_10px_rgba(0,0,0,0.35)]",
              ].join(" ")}
            >
              {pieceChar(pc)}
            </span>
